...
class ocp{
    public:
        ...
        struct Stage{
            ...
            std::unordered_map<std::string, std::shared_ptr<VariableXd>> variables;
        ...
        void updateDVariables(const std::vector<Eigen::VectorXd>& dx0, const std::vector<Eigen::VectorXd>& du0);
