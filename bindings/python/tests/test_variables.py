...
class TestVariables(unittest.TestCase):
    def test_variables(self):
        ...
        self.assertTrue((V3.getM() == (M1 - M2)).all())
        self.assertTrue((V3.getq() == (q1 - q2)).all())
        ...
        print(f"M4: {V4.getM()}")
        print(f"q4: {V4.getq()}")
        self.assertTrue((V4.getM() == M1).all())
        self.assertTrue((V4.getq() == (q1 - v)).all())

        V5 = V1 + V2
        self.assertTrue((V5.getM() == (M1 + M2)).all())
        self.assertTrue((V5.getq() == (q1 + q2)).all())
        ...
        self.assertTrue((x.getValue(w) == w[0:4]).all())
        self.assertTrue((u.getValue(w) == w[4:]).all())
