...
class TestAggregated(unittest.TestCase):
    def test_aggregated(self):
        ...
        self.assertTrue((c3.getAineq() == Aineq).all())
        self.assertTrue((c3.getbLowerBound() == bLowerBound).all())
        self.assertTrue((c3.getbUpperBound() == bUpperBound).all())
        ...
        self.assertTrue((c1.getbLowerBound() == c3.getbLowerBound()[0]).all())
        self.assertTrue((c1.getbUpperBound() == c3.getbUpperBound()[0]).all())
        ...
        self.assertTrue((clist[0].getAineq() == c5.getAineq()[0,:]).all())
        self.assertTrue((clist[0].getbLowerBound() == c5.getbLowerBound()[0]).all())
        self.assertTrue((clist[0].getbUpperBound() == c5.getbUpperBound()[0]).all())

        self.assertTrue((clist[1].getAineq() == c5.getAineq()[1,:]).all())
        self.assertTrue((clist[1].getbLowerBound() == c5.getbLowerBound()[1]).all())
        self.assertTrue((clist[1].getbUpperBound() == c5.getbUpperBound()[1]).all())

        self.assertTrue((clist[2].getAineq() == c5.getAineq()[2,:]).all())
        self.assertTrue((clist[2].getbLowerBound() == c5.getbLowerBound()[2]).all())
        self.assertTrue((clist[2].getbUpperBound() == c5.getbUpperBound()[2]).all())
        ...
        self.assertTrue((t1.getA() == t3.getA()[0:2, :]).all())
        self.assertTrue((t1.getb() == t3.getb()[0:2]).all())

        self.assertTrue((t2.getA() == t3.getA()[2:5, :]).all())
        self.assertTrue((t2.getb() == t3.getb()[2:5]).all())
        ...
        self.assertTrue((t1.getA() == t5.getA()[0:2, :]).all())
        self.assertTrue((t1.getb() == t5.getb()[0:2]).all())

        self.assertTrue((t2.getA() == t5.getA()[2:5, :]).all())
        self.assertTrue((t2.getb() == t5.getb()[2:5]).all())

        self.assertTrue((t4.getA() == t5.getA()[5:6, :]).all())
        self.assertTrue((t4.getb() == t5.getb()[5:6]).all())
        ...
        for i in range(2):
            self.assertTrue((sc5.getAineq()[i,:] == c5.getAineq()[idx[i],:]).all())
            self.assertTrue((sc5.getbLowerBound()[i] == c5.getbLowerBound()[idx[i]]).all())
            self.assertTrue((sc5.getbUpperBound()[i] == c5.getbUpperBound()[idx[i]]).all())
        ...
        self.assertTrue((sc5.getbLowerBound()[0] == c1.getbLowerBound()).all())
        self.assertTrue((sc5.getbUpperBound()[0] == c1.getbUpperBound()).all())
        #
        ...
        c5.update()
        print(f"c5.getAineq(): {c5.getAineq()}")
        self.assertTrue((c5.getAineq()[0,1] == False).all())
        #
        c5.setActiveJointsMask(c1_joint_mask)
        c5.update()
        print(f"c5.getAineq(): {c5.getAineq()}")
        self.assertTrue((c5.getAineq()[:,1] == False).all())
